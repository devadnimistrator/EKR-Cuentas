    ...
    <div class="x_panel">
      <div class="x_title">
        ...
        <ul class="nav navbar-right panel_toolbox">
          <li><a href="<?php echo base_url("education/categories"); ?>"><i class="fa fa-tags"></i> <?php ___("Categories"); ?></a>
        </ul>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <?php
        $product_m->form_add_element("category_id", array('type' => 'select', 'options' => $this->categories));
