      ...
      <div class="x_content">
        <div class="row">
          <form method="post" name="frmFilter" id="frmFilter" class="form-filters">
            ...
            <div class="input-group input-daterange" onchangedate="reloadTable(true)">
              <input type="text" name="start_date" id="start_date" value="<?php echo $start_date ?>" class="form-control input-sm"/>
              <div class="input-group-addon">to</div>
              <input type="text" name="end_date" id="end_date" value="<?php echo $end_date ?>" class="form-control input-sm" />
            </div>
          </form>
          <div class="clearfix"></div>
        </div>
      ...
      ajax: {
        ...
        data: function (d) {
          lastSearchParams = $.extend({}, d, {
            ...
            start_date: document.frmFilter.start_date.value,
            end_date: document.frmFilter.end_date.value
          });
