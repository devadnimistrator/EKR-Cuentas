  ...
  <div class="col-md-8 col-sm-6 col-xs-12">
    <div class="x_panel">
      <div class="x_title">						
        ...
        <ul class="nav navbar-right panel_toolbox">
          <li>
            <button class="btn btn-primary btn-xs" onclick="location.href='<?php echo base_url("expenses/categories"); ?>'">
              <?php ___("Add New"); ?>
            </button>
          </li>
        </ul>
...
<script>
  function saveCategory() {
    ...
    $.post("<?php echo base_url("expenses/categories/ajax_save_category"); ?>", $("#form-edtiCategory").serialize(), function (message) {
  ...
  function deleteCategory() {
    ...
    $.get("<?php echo base_url("expenses/categories/ajax_delete_category"); ?>/" + treeViewOptions.selectedNode.id, function (message) {
      $("#system-message").html(message);
  ...
  function initView() {
    $.getJSON("<?php echo base_url("expenses/categories/ajax_get_all_categories"); ?>", function (categories) {
