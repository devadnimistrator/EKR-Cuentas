...
<div class="page-title">
  ...
  <div class="title_right">
    <div class="pull-right">
      <button type="button" class="btn btn-round btn-primary btn-sm" onclick="location.href = '<?php echo base_url("categories"); ?>'"><?php ___("Add New"); ?></button>
    </div>
  </div>
</div>
...
<script>
  function saveCategory() {
    ...
    $.post("<?php echo base_url("categories/ajax_save_category"); ?>", $("#form-edtiCategory").serialize(), function (message) {
  ...
  function deleteCategory() {
    if (treeViewOptions.selectedNode.parent_id == 0) {
      if (!confirm("<?php ___("If delete this category, will remove all child categories."); ?>\n<?php ___("Are you sure delete?") ?>")) {
        return;
      }
    }
    $.get("<?php echo base_url("categories/ajax_delete_category"); ?>/" + treeViewOptions.selectedNode.id, function (message) {
      $("#system-message").html(message);
  ...
  function initView() {
    $.getJSON("<?php echo base_url("categories/ajax_get_parent_categories"); ?>", function (categories) {
    ...
    $.getJSON("<?php echo base_url("categories/ajax_get_all_categories"); ?>", function (categories) {
